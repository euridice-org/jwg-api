...
RuleSet: CapabilityStatement-AllergyIntolerance( requirement )
// AllergyIntolerance
* resource[+]
...
* resource[+]
  ...
  * searchParam[=].extension.valueCode = #SHOULD
...
RuleSet: CapabilityStatement-Immunization( requirement )
* resource[+]
  * extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension[=].valueCode = {requirement}
  * type = #Immunization
...
RuleSet: CapabilityStatement-Medication( requirement )
* resource[+]
  * extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension[=].valueCode = {requirement} 
  * type = #Medication
...
RuleSet: CapabilityStatement-MedicationRequest( requirement )
* resource[+]
  * extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension[=].valueCode = {requirement}
...
RuleSet: CapabilityStatement-MedicationStatement( requirement )
* resource[+]
  * extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension[=].valueCode = {requirement}
...
//  * profile = "http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-medicationstatement"
  ...
  * interaction[0].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * interaction[=].extension.valueCode = {requirement}
  * interaction[=].code = #read
  * interaction[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * interaction[=].extension.valueCode = #SHALL
  * interaction[=].code = #search-type
...
RuleSet: CapabilityStatement-Observation( requirement )
* resource[+]
  * extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"  
  * extension[=].valueCode = {requirement}
  * extension[+].extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
...
// RuleSet: CapabilityStatement-Patient( requirement )
// * resource[+]
//   * type = #Patient\
//   * insert CapabilityStatement-Expectation( {requirement} )
...
* resource[+]
  * extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension[=].valueCode = {requirement}  * extension.valueCode = #SHOULD
  * type = #Practitioner
...
RuleSet: CapabilityStatement-DiagnosticReport( requirement )
* resource[+]
...
RuleSet: CapabilityStatement-Procedure( requirement )
* resource[+]
  * extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension[=].valueCode = {requirement}  
  * extension[+].extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
...
RuleSet: CapabilityStatement-Encounter( requirement )
* resource[+]
  * extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension[=].valueCode = {requirement}  
  * extension[+].extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
...
RuleSet: CapabilityStatement-Provenance( requirement )
* resource[+]
  * extension[0].url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension[=].valueCode = {requirement}  
  * type = #Provenance
   ...
   //* supportedProfile[=].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
   //* supportedProfile[=].extension.valueCode = #SHALL
  * interaction[0].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * interaction[=].extension.valueCode = #SHALL
  * interaction[=].code = #read
  * interaction[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
