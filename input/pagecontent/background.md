This section provides background and context for understanding the EU Health Data API specification.
...
The specification addresses requirements from the European Health Data Space (EHDS) regulation. See [Regulatory Anchors](regulatoryAnchors.html) for details on how this IG relates to EHDS requirements and the work of the Xt-EHR Joint Action.
...
After understanding the background and context:
