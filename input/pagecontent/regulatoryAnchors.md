...
| `api-consumer-authPresentToken` | The EHR system Interoperability Software Component SHALL present a valid token to the Provider EHR on Interoperability Component Exchange. | Annex II §1.4, Art. 36(3)(e) | Consumer | [Token Usage](authorization.html#presenting-tokens) | Bearer token in Authorization header, SMART App Launch, IHE IUA |
